...
const { nodes, materials } = useGLTF(`${import.meta.env.BASE_URL}models/WawaOffice.glb`);
  ...
  //#region for study later //gsap-animation
...
useGLTF.preload(`${import.meta.env.BASE_URL}models/WawaOffice.glb`);
